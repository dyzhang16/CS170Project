...
public class old_BasketballMovement : MonoBehaviour
{
	// Attached Unity Objects
	[SerializeField]
	private old_BasketballGameplay gameplayComponent;
	...
	void Start()
	{
		...
		{
			gameplayComponent = GameObject.Find("BasketballPanel").GetComponent<old_BasketballGameplay>();
		}
	}
